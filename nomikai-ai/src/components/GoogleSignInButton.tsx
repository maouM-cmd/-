...
export function GoogleSignInButton({ enabled }: { enabled: boolean }) {
  ...
  return (
    <a
      ...
      className="flex min-h-[48px] w-full items-center justify-center gap-3 rounded-2xl border border-gray-200 bg-white font-medium text-gray-700 hover:bg-gray-50"
    >
