...
| ティア | 価格 | 内容 |
|--------|------|------|
| Free | $0 | `free/` — 5社データ + 型定義 |
| Paid | $39 | フルキット（本ディレクトリ） |

- 切り分け詳細: [docs/FREE_PAID_SPLIT.md](../docs/FREE_PAID_SPLIT.md)
- Gumroad出品文: [sales/GUMROAD_LISTING.md](sales/GUMROAD_LISTING.md)
- デモツール: `/tools/compare`（coupon-board サイト）

```bash
# 無料版データ再生成
node scripts/build-free-tier.mjs
```

## ライセンス

[LICENSE.md](LICENSE.md) を参照。数値は参考値であり、投資判断には使わないでください。
